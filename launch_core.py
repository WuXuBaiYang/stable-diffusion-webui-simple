...
def prepare_environment():
    ...
    requirements_file = os.environ.get('REQS_FILE', "requirements_versions_core.txt")
    commandline_args = os.environ.get('COMMANDLINE_ARGS', "")

    xformers_package = os.environ.get('XFORMERS_PACKAGE', 'xformers==0.0.16rc425')
    gfpgan_package = os.environ.get('GFPGAN_PACKAGE', "gfpgan==1.3.8")
    clip_package = os.environ.get('CLIP_PACKAGE', "clip-openai==1.0.post20230121")
    openclip_package = os.environ.get('OPENCLIP_PACKAGE', "open-clip-torch==2.14.0")
